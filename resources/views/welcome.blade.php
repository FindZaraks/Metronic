                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-lg " name="first_name" placeholder="First Name" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Last Name *</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="last_name" placeholder="Last Name" value="" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Address2</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="address2" placeholder="Address2" value="" />
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="zip_code" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="username" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-lg " name="company_name" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Company Address *</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_address" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Address2</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_address2" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">City</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_city" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">State</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_state" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Zip Code</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_zip_code" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Business Phone</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_phone" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Business Email</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_email" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Business Website</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_website" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Date Joined</label>
                                                <input type="date" class="form-control form-control-lg form-control-solid" name="company_date_joined" placeholder="" value="" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Subscription Plan</label>
                                                <select class="" name="company_subscription_plan">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label mb-3">Account Status</label>
                                                <input type="text" class="form-control form-control-lg form-control-solid" name="company_account_status" placeholder="" value="" />
                                            </div>
                                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-8 pb-lg-10">
                                    ...
                                    <div class="text-muted fw-semibold fs-6">If you need more info, please
                                        <a href="../../demo14/dist/.html" class="link-primary fw-bold">Sign In</a>.</div>
                                    <!--end::Notice-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Body-->
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <div class="fw-semibold">
                                                ...
                                                <div class="fs-6 text-gray-700">To start using great tools, please,
                                                    <a href="../../demo14/dist/utilities/wizards/vertical.html" class="fw-bold">Create Team Platform</a></div>
                                            </div>
                                            <!--end::Content-->
                                        </div>
                                        <!--end::Wrapper-->
